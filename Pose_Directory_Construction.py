...
save_path = '/DATA/sanjay/VT-GAN-master/CASIA_B/CASIA_B180degree_Centered_Alinged_Pose_Directory_with_length_'+str(division)+'/'
#print(path1)
subjects = os.listdir(path1)
subjectsNumber = len(subjects)
#print(subjectsNumber)
for number1 in range(0,20):#subjectsNumber
  if (number1+1)<10:
    sub1 = '00' + str(number1+1)
  else:
    if (number1)<100:
      sub1 = '0' + str(number1+1)
    else:
      sub1 = str(number1+1)
  path2 = path1+sub1+'/'
