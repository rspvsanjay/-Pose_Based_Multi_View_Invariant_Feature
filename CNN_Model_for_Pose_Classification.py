...
src_dir = '/DATA/sanjay/VT-GAN-master/CASIA_B/CASIA_B_pose_data_to_train_CNN/CASIA_B162degree_Centered_Alinged_Pose_Directory_with_length_5_selected/'
save_path = '/DATA/sanjay/VT-GAN-master/CASIA_B/CASIA_B_pose_data_to_train_CNN'
train_imgs = []
train_labels = []
test_imgs = []
test_labels = []
poses = os.listdir(src_dir)
numberOfPoses = len(poses)
...
model_name = 'GEINet_Model_with_Pose_length_'+str(division)+'for_162.h5'
